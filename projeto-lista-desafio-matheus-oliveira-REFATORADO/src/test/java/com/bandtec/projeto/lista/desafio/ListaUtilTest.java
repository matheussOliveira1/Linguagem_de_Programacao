...
public class ListaUtilTest {
  ...
  @Test
    ...
    @Test
    @DisplayName("hasDuplicidade(): Quando a lista possuir valores duplicados deve retornar true (42)")
    ...
    @Test
    @DisplayName("hasDuplicidade(): Quando a lista possuir valores duplicados deve retornar true (88)")
    public void testHasDuplicidadeQuandoAcionadoEListaPossuiDuplicidadeDeveRetornarTrue2() {
        ListaUtil instance = new ListaUtil();
    ...
    @Test
    @DisplayName("hasDuplicidade(): Quando a lista possuir valores duplicados deve retornar true (6)")
    public void testHasDuplicidadeQuandoAcionadoEListaPossuiDuplicidadeDeveRetornarTrue3() {
        ListaUtil instance = new ListaUtil();
